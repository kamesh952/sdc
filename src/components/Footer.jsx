...
const Footer = () => {
  return (
    <footer className="bg-gray-50 text-gray-600 pt-12 pb-6 px-4 sm:px-6 lg:px-8 font-outfit">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          
          {/* Company Info */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-800">EventPro</h3>
            <p className="text-sm">
              Professional event management services to make your occasions memorable.
            </p>
          ...
          <div className="space-y-4">
            ...
            <address className="not-italic text-sm space-y-2">
              <p>Chrompet,</p>
              <p>Chennai</p>
              <p>Email: kameshramesh006@gmail.com</p>
              <p>Phone: +91 8680892898</p>
            </address>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">Subscribe to get updates on our latest events</p>
            <form className="flex flex-col sm:flex-row gap-2">
              <input 
                type="email" 
                placeholder="Your email" 
                className="px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent text-sm flex-grow"
                required
              />
              <button 
                type="submit" 
